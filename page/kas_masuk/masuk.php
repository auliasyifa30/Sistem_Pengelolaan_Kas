                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>
                            ...
                            <!-- button hapus -->
                            <a onclick="return confirm('Yakin Akan Menghapus Data Ini ?')" href="?page=masuk&aksi=hapus&id=<?php echo $data['kode']; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
                        </td>
                    </tr>
