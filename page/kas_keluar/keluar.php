<div class="row">
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"> Data Kas Keluar </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <!--  halaman tambah data-->
                        <div class="panel-body">
                            <button class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i> Tambah</button>
                            ...
                            <!-- tabel yang akan dibuat sesuai dengan yang ada pada database -->
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <!-- button edit -->
                                        <a  style="margin-left: 10px" id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $data['kode'] ?>" data-ket="<?php echo $data['keterangan'] ?>" data-tgl="<?php echo $data['tgl'] ?>" data-jml="<?php echo $data['keluar'] ?>" class="btn btn-info"><i class="fa fa-edit"></i> Edit</a>

                                        <a style="margin-left: 10px" onclick="return confirm('Yakin Akan Menghapus Data Ini ?')" href="?page=keluar&aksi=hapus&id=<?php echo $data['kode']; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
                                    </td>
                                </tr>
